...
/u/leongs/MCSYM-soft/cgi-bin/Tinker_copy/Tinker/prepkey.exe $pdb_prefix.xyz 200 | sed 's/parameters .\{1,\}amber99/parameters \/u\/major\/bin\/Tinker\/amber99/' > $pdb_prefix.min.key
/u/leongs/MCSYM-soft/cgi-bin/Tinker_copy/Tinker/minimize $pdb_prefix.xyz -k $pdb_prefix.min.key 5.0
